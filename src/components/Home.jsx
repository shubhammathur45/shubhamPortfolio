        ...
        <div
            ...
            <div className="max-w-screen-lg mx-auto flex flex-col items-center justify-center h-full px-4 md:flex-row text-white">
                <div className="flex flex-col justify-center h-full">
                    ...
                    <h2 className="text-4xl sm:text-6xl font-bold text-white font-mono overflow-hidden whitespace-nowrap border-b-4 animate-underline duration-1000 border-r-2">Shubham Mathur
                    </h2>
